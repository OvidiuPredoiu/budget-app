...
INSERT INTO "new_UserPermissions" ("analytics", "banking", "budgets", "categories", "currency", "dashboard", "developer", "goals", "id", "insights", "investments", "predictions", "receipts", "recurring", "reports", "sharedBudgets", "subscriptions", "tax", "transactions", "updatedAt", "userId", "whiteLabel") SELECT "analytics", "banking", "budgets", "categories", "currency", "dashboard", "developer", "goals", "id", "insights", "investments", "predictions", "receipts", "recurring", "reports", "sharedBudgets", "subscriptions", "tax", "transactions", "updatedAt", "userId", "whiteLabel" FROM "UserPermissions";
